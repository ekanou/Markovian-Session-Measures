...
def sDCG(run_file_path, truth_xml_path, dd_info_path, bq=4, b=2, cutoff=10, verbose=False, max_doc_rel=True):
    """
    :param run_file_path:
    ...
    :return: average sDCG and nsDCG over all topics
    """
...
def sDCG_per_topic(topic_truth, topic_result, bq, b, cutoff, list_depth):
...
def sDCG_bound_per_topic(topic_truth, bq, b, cutoff, list_depth):
    """
